...
(potential U.S. customers). It contains a random sample of 500
households with positive incomes that were interviewed in the 2004
survey. For term life insurance, the quantity of insurance is measured
by the policy face, the amount that the company will pay in the event of
the death of the named insured. Characteristics include annual income,
the number of years of education of the survey respondent and the number
...
- `MarStat`:
  ...
  Marital status of the survey respondent: 1 if married, 2 if living
  with partner, and 0 otherwise.
...
- `Face`:
  ...
  Amount that the company will pay in the event of the death of the
  named insured.
