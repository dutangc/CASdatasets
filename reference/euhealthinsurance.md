...
The `euhealthinsurance` compiles data coming from a health group
collective fund that covers different kind of health perils to the
members. Available data are: gender, age at inception of coverage, role
in the policy, number and agggregate amount.
...
`euhealthinsurance` is a dataframe with 157221 observations and 21
columns
