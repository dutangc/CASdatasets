...
The `euMTPL` compiles three years of experience from a European MTPL
(Motor Third Party Liability) portfolio, including frequency and
severity values for different types of losses. The data was collected
...
- `group`:
  ...
  Data split into training, validation, and test sets using a 70/10/20
  ratio.
