...
This dataset is based on a real dataset acquired from a Canadian-based
insurer, which offered a UBI program that was launched in 2013, to its
automobile insurance policyholders. The observation period was for the
years between 2013 and 2016, with over 70,000 policies being observed,
for which the dataset drawn is pre-engineered for training a statistical
...
[http://www2.math.uconn.edu/~valdez/data.html](http://www2.math.uconn.edu/~valdez/data.md)

## References

Banghee So, Jean-Philippe Boucher and Emiliano A. Valdez (2021),
*Synthetic Dataset Generation of DriverTelematics*, Risks 9:58,
[doi:10.3390/risks9040058](https://doi.org/10.3390/risks9040058)
