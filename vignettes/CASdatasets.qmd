...
-  Brazil:
     ...
     - [`brgeomunicins`](https://dutangc.github.io/CASdatasets/reference/brgeomunicins.html): a dataset of Brazilian cities with
            ...
            Geographical datasetsbrgeomunic_sf`,brgeomunic_sp` should
            be downloaded from the github repository in extra directorygeodata`.
...
- Chapter 5:accidents` andaccidents_data` are 
      merged in [`brautocoll`](https://dutangc.github.io/CASdatasets/reference/brautocoll.html);55mu2500gsd` isbrgeomunic_sf` in 
      extra directorygeodata` in the github repository;
