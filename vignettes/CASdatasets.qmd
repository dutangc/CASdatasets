...
-  Brazil:
     ...
     - [`brgeomunicins`](https://dutangc.github.io/CASdatasets/reference/brgeomunicins.html): a dataset of Brazilian cities with
            ...
            Geographical datasets `brgeomunic_sf, `brgeomunic_sp
            should be downloaded from the github repository
            in extra directory `geodata/.
...
- Chapter 5: `accidents` and `accidents_data` are 
      merged in [`brautocoll`](https://dutangc.github.io/CASdatasets/reference/brautocoll.html);
      `55mu2500gsd` is `brgeomunic_sf` in extra directory `geodata/
