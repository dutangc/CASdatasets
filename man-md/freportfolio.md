...
- **`Gender`**: the sex: `M` for male and `F` for female.
- **`JobType`**: the job category: `"employee"`, `"managers, engineers, sales responsibles"`, `"non-manager employee"` `"other 1"`, `"other 2"`, `"other 3"`, `"other 4"`, `"other 5"`, `"technician"`, `"unemployed workers"`.
