...
where `YYYYMM` is the concatenation of the year `YYYY` and month `MM=12`, e.g. `200512`. `ausNLHYLloydGPI` (Table 17) is a data frame of 4 columns (values are in thousand of Australian dollars (AUD)):
